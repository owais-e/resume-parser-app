...
pinecone_apikey = "23bf90b8-28e0-45de-8339-28c1f8030eb7"
...
def main():
    ...
    if submit:
        with st.spinner("Wait, It's in progress...."):
            ...
            st.write("Total Resume Uploaded : ", len(docs))
            ...
            relevant_docs = similar_docs(job_description, document_count, pinecone_apikey, pinecone_environment,
                                         pinecone_index_name, embeddings, st.session_state['unique_id'])
